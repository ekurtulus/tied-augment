...
class CriterionHandler(nn.Module):
    ...
    def forward(self, first_logits, second_logits, first_features, second_features, y, ce=True, contrastive=True):
        ...
        if ce and contrastive:
            return self.supervised(first_logits, second_logits, y) - contrastive_weight * self.contrastive(first_features, second_features)
        elif ce:
            return self.supervised(first_logits, second_logits, y) 
        elif contrastive:
            return -contrastive_weight * self.contrastive(first_features, second_features)
